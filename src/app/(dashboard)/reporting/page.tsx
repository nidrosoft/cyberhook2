...
export default function ReportingPage() {
    ...
    const generatePerformanceReport = useCallback(() => {
        ...
        doc.text("CyberHook AI", margin, 18);
        doc.setFontSize(11);
        ...
        doc.text(`Generated by CyberHook AI on ${now.toLocaleDateString("en-US", { weekday: "long", month: "long", day: "numeric", year: "numeric" })} at ${now.toLocaleTimeString()}`, margin, y);
        y += 4;
        ...
        const companySlug = (company?.name ?? "CyberHook AI").replace(/[^a-zA-Z0-9]/g, "_");
                ...
                <div className="mx-auto w-full max-w-[1440px] px-4 sm:px-8 py-8 flex flex-col gap-8">
                    ...
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between border-b border-secondary pb-6">
                        ...
                        <div className="flex flex-wrap items-center gap-3">
                            ...
                            <Button size="md" color="secondary" iconLeading={FileCheck02} onClick={generatePerformanceReport} data-tour="reporting-generate">
                                Generate PDF Report
                            </Button>
