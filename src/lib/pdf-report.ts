...
export async function generateExposureReport(data: ReportData) {
    ...
    const mspName = data.mspCompanyName || "CyberHook AI Partner";
    ...
    for (let page = 1; page <= pageCount; page += 1) {
        ...
        if (logoDataUrl) {
            try {
                ...
                doc.text(`Generated by CyberHook AI for ${mspName}`, margin + 13, pageHeight - 10);
            } catch {
                doc.text(`Generated by CyberHook AI for ${mspName}`, margin, pageHeight - 10);
            }
        } else {
            doc.text(`Generated by CyberHook AI for ${mspName}`, margin, pageHeight - 10);
        }
