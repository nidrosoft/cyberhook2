...
import { LifeBuoy01, LogOut01, Settings01, ChevronLeft, ChevronRight } from "@untitledui/icons";
        ...
        >
            ...
            >
                <div className="flex justify-center px-3">
                    <CyberHookLogoMinimal className="size-8" />
                </div>
    ...
    return (
        <>
            ...
            <motion.div
                initial={false}
                animate={{
                    width: MAIN_SIDEBAR_WIDTH + (isSecondarySidebarVisible ? SECONDARY_SIDEBAR_WIDTH : 0),
                }}
                transition={{ type: "spring", damping: 26, stiffness: 220, bounce: 0 }}
                className="invisible hidden shrink-0 lg:sticky lg:top-0 lg:bottom-0 lg:left-0 lg:block"
            />
